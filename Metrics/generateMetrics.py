...
# ============================
plt.figure(figsize=(8, 4))
plt.plot(epochs, pos_dist, marker="o", label="Avg Anchor-Positive Distance")
plt.plot(epochs, neg_dist, marker="s", label="Avg Anchor-Negative Distance")
plt.xlabel("Epoch")
plt.ylabel("Embedding Distance")
plt.title("Avg Anchor-Positive vs Anchor-Negative Distance vs Epoch")
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
